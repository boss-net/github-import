...
const defaults = {
  apiBase: 'https://boss-net.github.io/api/v1',
  githubUrl: 'https://api.github.com',
  days: 1,
};

const help = `
Usage: boss-net-github-import --orgId=<orgId> --integrationId=<integrationId> --githubToken=<githubToken>
...
const apiKey = process.env.BOSS_TOKEN;
